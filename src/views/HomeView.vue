      ...
      <el-col :span="8">
        ...
        <el-card class="sidebar-card stats-card" shadow="never">
          ...
          <div class="stats-grid">
            <div class="stat-item">
              <div class="stat-value">{{ statsData.articleCount }}</div>
              <div class="stat-label">文章数</div>
            </div>
            <div class="stat-item">
              <div class="stat-value">{{ statsData.totalViews }}</div>
              <div class="stat-label">总浏览</div>
            </div>
            <div class="stat-item">
              <div class="stat-value">{{ statsData.likeCount }}</div>
              <div class="stat-label">获赞数</div>
            </div>
            <div class="stat-item">
              <div class="stat-value">{{ statsData.followerCount }}</div>
              <div class="stat-label">粉丝数</div>
            </div>
          </div>
          <el-button type="primary" class="write-btn" @click="handleWrite">
...
const fetchArticles = async () => {
  try {
    const res = await request.get('/artwork/feed', {
      params: { current: currentPage.value, size: pageSize.value, tagId: activeTagId.value }
    })
